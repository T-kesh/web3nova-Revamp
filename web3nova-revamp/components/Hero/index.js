  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#0f0f1a] to-[#0a0a0a] text-white font-sans relative overflow-hidden">
      ...
      {bubbles.map(bubble => (
        <div
          key={bubble.id}
          className="absolute rounded-full pointer-events-none animate-bubble-float"
          style={{
            left: `${bubble.x}%`,
            top: `${bubble.y}%`,
            width: `${bubble.size}px`,
            height: `${bubble.size}px`,
            background: `radial-gradient(circle at 30% 30%, rgba(46, 123, 209, 0.3), rgba(146, 180, 228, 0.2), transparent)`,
            border: '1px solid rgba(255, 255, 255, 0.1)',
            boxShadow: '0 8px 32px rgba(46, 123, 209, 0.2), inset 0 0 20px rgba(255, 255, 255, 0.1)',
      ...
      <main className="relative z-10 flex flex-col items-center justify-center px-6 md:px-8 py-16 md:py-20 max-w-5xl mx-auto text-center min-h-screen">
        ...
        >
          <span className="text-xs md:text-sm font-medium">
            ...
            <span className="font-bold mx-1 md:mx-2 text-[#FFB800]">With</span>{" "}
            Web3Nova
          </span>
          <svg
            className="w-3.5 h-3.5 md:w-4 md:h-4 text-[#FFB800]"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <h1
          ...
          style={{
            ...
            textShadow:
              "0 4px 30px rgba(46, 123, 209, 0.5), 0 0 60px rgba(46, 123, 209, 0.2)",
          }}
        >
          Learn, Build &<br />
          Earn <br />
        ...
        <p className="text-base md:text-lg lg:text-xl text-white/80 mb-8 md:mb-10 max-w-2xl leading-relaxed px-4 md:px-6 py-3 md:py-4 rounded-2xl bg-gradient-to-r from-white/5 via-white/10 to-white/5 backdrop-blur-md border border-white/15 shadow-2xl animate-fade-in-up">
          Web3Nova is your launchpad into the world of Web3. Whether you&apos;re
          looking to start a career in blockchain development through our
          16-week hands-on bootcamp, or seeking expert-led design and
          development services for your Web3 project.
        </p>
      ...
      <style jsx global>{`
        ...
        * {
        ...
        @keyframes pulse-ring {
          0% {
            box-shadow: 0 0 0 0 rgba(46, 123, 209, 0.7);
            transform: scale(1);
          }
          50% {
            box-shadow: 0 0 0 10px rgba(46, 123, 209, 0);
            transform: scale(1.05);
          }
          100% {
            box-shadow: 0 0 0 0 rgba(46, 123, 209, 0);
            transform: scale(1);
          }
        }
        ...
        .animate-vibrate-attention {
          animation: vibrate-attention 3s ease-in-out infinite;
        }
